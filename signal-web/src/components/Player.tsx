      ...
      <div className="flex-1 overflow-hidden flex">
        ...
        <div className={`flex-1 flex flex-col items-center justify-center p-8 ${showScript ? 'w-1/2' : 'w-full'}`}>
          ...
          <div className="text-center mb-8">
            <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-[--color-accent-blue] to-[--color-accent-purple] flex items-center justify-center text-6xl mb-4 mx-auto">
              🎙️
            </div>
          ...
          <div className="flex items-center gap-6 mt-6">
            ...
            <button
              onClick={togglePlay}
              className="w-16 h-16 rounded-full bg-[--color-accent-blue] text-white flex items-center justify-center text-2xl hover:opacity-90 transition"
            >
              {isPlaying ? '⏸' : '▶'}
            </button>
